...
<br/>2. The transition to remote might take a while and result in a lot of downtime and issues.
...
<br/>3. Since the application is going online, there is always the concern of network security and how the employees are accessing the program.
